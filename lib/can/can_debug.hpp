...
#define CAN_DEBUG_PRINT_ERROR(fmt, ...) \
    DEBUG_PRINT_ERROR(CAN_SYSTEM_STR, CAN_COLOR_STR, fmt, ##__VA_ARGS__)
#define CAN_DEBUG_PRINT_ERRORLN(fmt, ...) \
    DEBUG_PRINT_ERRORLN(CAN_SYSTEM_STR, CAN_COLOR_STR, fmt, ##__VA_ARGS__)
#define CAN_DEBUG_PRINT_FATAL_ERROR(fmt, ...) \
    DEBUG_PRINT_FATAL_ERROR(CAN_SYSTEM_STR, CAN_COLOR_STR, fmt, ##__VA_ARGS__)
#define CAN_DEBUG_PRINT_FATAL_ERRORLN(fmt, ...) \
    DEBUG_PRINT_FATAL_ERRORLN(CAN_SYSTEM_STR, CAN_COLOR_STR, fmt, ##__VA_ARGS__)
